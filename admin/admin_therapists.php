<?php 
// admin_therapists_index.php
// 12-23-11 rlb
// administration page for website Therapists page
// displays editable fields as link

require_once("code/admin_include.php");
require("code/admin_login_check.php");
require("code/admin_therapists_init.php");
...
<?php require("html/admin_header.php"); ?>
	<div id="content">
		<div id="left">
			<?php require(ADMIN_PATH."contents/therapists_left.php");?>
		</div><!-- end of div - left -->
		<div id="right">
